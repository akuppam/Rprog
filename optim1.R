...
# **********************
# Modeling and Solving Linear Programming with R.PDF
# **********************
# section 2.2.2
# **************
library(lpSolve)
...
prod.sol$objval       # reports maximixed value
prod.sol$obj.val      
prod.sol$solution     # reports individual variable values
prod.sol$duals
